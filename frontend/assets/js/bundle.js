...
const formClass_1 = __webpack_require__(/*! ./formClass */ "./src/webpack/formClass.ts");
...
const rpassword = document.querySelector('.password2');
form.addEventListener('submit', (event) => {
    ...
    if (sendForm(form)) {
        ...
        const registeredUser = new formClass_1.User(user.value, email.value, password.value);
...
function showErrorMessage(input, msg) {
    const formFields = input.parentElement; // Seleciono o pai do input, que nesse caso, seria a form-fields
...
function checkEmail(email) {
    if (!(0, isEmail_1.default)(email.value))
        showErrorMessage(email, 'precisa ser válido.');
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./formController */ "./src/webpack/formController.ts");
